...
<?php $this->beginPage(); ?>
    ...
    <header id="header">
        <div class="header-inner">
            <!-- Header image -->
            <img src="source/images/header-bg.jpg" alt="img">
                        ...
                        <div class="row">
                            <div class="col-md-5 col-sm-6 col-xs-12">
                                <div class="about-left wow fadeInLeft">
                                    <img src="source/images/about-img.jpg" alt="img">
    ...
    <section id="call-to-action">
        <img src="source/images/call-to-action-bg.png" alt="img">
                            ...
                            <div id="mixit-container" class="portfolio-container">
                                <div class="single-portfolio mix branding">
                                    <div class="single-item">
                                        <img src="source/images/portfolio-img-small1.jpg" alt="img">
                                        <div class="single-item-content">
                                            <div class="portfolio-social-icon">
                                                <a class="fancybox" data-fancybox-group="gallery" href="source/images/portfolio-img-big1.jpg"><i class="fa fa-eye"></i></a>
                                ...
                                <div class="single-portfolio mix design">
                                    <div class="single-item">
                                        <img src="source/images/portfolio-img-small2.jpg" alt="img">
                                        <div class="single-item-content">
                                            <div class="portfolio-social-icon">
                                                <a class="fancybox" data-fancybox-group="gallery" href="source/images/portfolio-img-big2.jpg"><i class="fa fa-eye"></i></a>
                                                <a class="link-btn" href="#"><i class="fa fa-link"></i></a>
                                            </div>
                                            <div class="portfolio-title">
                                                <h4>Mobile application</h4>
                                ...
                                <div class="single-portfolio mix development">
                                    <div class="single-item">
                                        <img src="source/images/portfolio-img-small3.jpg" alt="img">
                                        <div class="single-item-content">
                                            <div class="portfolio-social-icon">
                                                <a class="fancybox" data-fancybox-group="gallery" href="source/images/portfolio-img-big3.jpg"><i class="fa fa-eye"></i></a>
                                                <a class="link-btn" href="#"><i class="fa fa-link"></i></a>
                                            </div>
                                            <div class="portfolio-title">
                                                <h4>Mobile application</h4>
                                ...
                                <div class="single-portfolio mix photography">
                                    <div class="single-item">
                                        <img src="source/images/portfolio-img-small4.jpg" alt="img">
                                        <div class="single-item-content">
                                            <div class="portfolio-social-icon">
                                                <a class="fancybox" data-fancybox-group="gallery" href="source/images/portfolio-img-big4.jpg"><i class="fa fa-eye"></i></a>
                                                <a class="link-btn" href="#"><i class="fa fa-link"></i></a>
                                            </div>
                                            <div class="portfolio-title">
                                                <h4>Mobile application</h4>
                                ...
                                <div class="single-portfolio mix photography">
                                    <div class="single-item">
                                        <img src="source/images/portfolio-img-small5.jpg" alt="img">
                                        <div class="single-item-content">
                                            <div class="portfolio-social-icon">
                                                <a class="fancybox" data-fancybox-group="gallery" href="source/images/portfolio-img-big5.jpg"><i class="fa fa-eye"></i></a>
                                                <a class="link-btn" href="#"><i class="fa fa-link"></i></a>
                                            </div>
                                            <div class="portfolio-title">
                                                <h4>Mobile application</h4>
                                ...
                                <div class="single-portfolio mix photography">
                                    <div class="single-item">
                                        <img src="source/images/portfolio-img-small6.jpg" alt="img">
                                        <div class="single-item-content">
                                            <div class="portfolio-social-icon">
                                                <a class="fancybox" data-fancybox-group="gallery" href="source/images/portfolio-img-big6.jpg"><i class="fa fa-eye"></i></a>
                                                <a class="link-btn" href="#"><i class="fa fa-link"></i></a>
                                            </div>
                                            <div class="portfolio-title">
                                                <h4>Mobile application</h4>
                                ...
                                <div class="single-portfolio mix photography">
                                    <div class="single-item">
                                        <img src="source/images/portfolio-img-small7.jpg" alt="img">
                                        <div class="single-item-content">
                                            <div class="portfolio-social-icon">
                                                <a class="fancybox" data-fancybox-group="gallery" href="source/images/portfolio-img-big7.jpg"><i class="fa fa-eye"></i></a>
                                                <a class="link-btn" href="#"><i class="fa fa-link"></i></a>
                                            </div>
                                            <div class="portfolio-title">
                                                <h4>Mobile application</h4>
    ...
    <section id="counter">
        <img src="source/images/counter-bg.jpg" alt="img">
    ...
    <section id="testimonial">
        <img src="source/images/testimonial-bg.jpg" alt="img">
        <div class="counter-overlay">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                                ...
                                <div class="testimonial-slider">
                                    ...
                                    <div class="single-slide">
                                        ...
                                        <div class="single-testimonial">
                                            <img class="testimonial-thumb" src="source/images/testimonial-image1.png" alt="img">
                                            <p>Jonna Hike</p>
                                    ...
                                    <div class="single-slide">
                                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamcoquat. Duis aute irure d olor in reprehenderit</p>
                                        <div class="single-testimonial">
                                            <img class="testimonial-thumb" src="source/images/team-member2.png" alt="img">
                                            <p>Jonna Hike</p>
                                            <span>CEO, Themeforest</span>
                                        </div>
                                    </div>
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <article class="single-from-blog">
                                        <figure>
                                            <a href="blog-single.html"><img src="source/images/the-sky.jpg" alt="img"></a>
                                        </figure>
                                ...
                                <div class="col-md-4">
                                    <article class="single-from-blog">
                                        <figure>
                                            <a href="blog-single.html"><img src="source/images/photographer.jpg" alt="img"></a>
                                        </figure>
                                        <div class="blog-title">
                                            <h2><a href="blog-single.html">Here is the post title</a></h2>
                                            <p>Posted by <a class="blog-admin" href="#">admin</a> on <span class="blog-date">23rd july 2015</span></p>
                                ...
                                <div class="col-md-4">
                                    <article class="single-from-blog">
                                        <figure>
                                            <a href="blog-single.html"><img src="source/images/sealand.jpg" alt="img"></a>
                                        </figure>
                                        <div class="blog-title">
                                            <h2><a href="blog-single.html">Here is the post title</a></h2>
                                            <p>Posted by <a class="blog-admin" href="#">admin</a> on <span class="blog-date">23rd july 2015</span></p>
                ...
                <div class="col-md-12">
                    <div class="client-area">
                        <ul class="client-table">
                            <li><img src="source/images/envato.png" alt="client logo"></li>
                            <li><img src="source/images/google.png" alt="client logo"></li>
                            <li><img src="source/images/amazon.png" alt="client logo"></li>
                            <li><img src="source/images/discovery.png" alt="client logo"></li>
                            <li><img src="source/images/envato.png" alt="client logo"></li>
                            <li><img src="source/images/tuenti.png" alt="client logo"></li>
                            <li><img src="source/images/envato.png" alt="client logo"></li>
                            <li><img src="source/images/google.png" alt="client logo"></li>
                            <li><img src="source/images/amazon.png" alt="client logo"></li>
                            <li><img src="source/images/discovery.png" alt="client logo"></li>
    ...
    <!--    --><? /*= $this -> render('@frontend/modules/main/views/main/contact') */ ?>
    <!-- End Contact section -->
    <!-- Start Google Map -->
